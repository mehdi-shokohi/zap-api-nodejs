...
Replacer.prototype.addRuleOnSite = function (description, enabled, matchtype, matchregex, matchstring, replacement, initiators,site, callback) {
  ...
  if (typeof callback === 'function') {
    this.api.request('/replacer/action/addRuleOnSite/', params, callback);
    return;
  }
  return this.api.requestPromise('/replacer/action/addRuleOnSite/', params);
};
/**
